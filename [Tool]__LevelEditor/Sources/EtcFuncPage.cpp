...
void CEtcFuncPage::OnBnClickedButtonLandEffAdd()
{
	...
	D3DXVECTOR2 vMin(min(m_vMinLandPos.x, m_vMaxLandPos.x), min(m_vMinLandPos.y, m_vMaxLandPos.y));
	D3DXVECTOR2 vMax(max(m_vMinLandPos.x, m_vMaxLandPos.x), max(m_vMinLandPos.y, m_vMaxLandPos.y));
